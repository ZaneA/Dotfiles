...
(setq packages
      '(angular-snippets auto-complete bind-key chicken-scheme direx
        direx-project edit-server evil fold-this git-gutter
        ...
        popup popwin pos-tip r5rs rainbow-delimiters rainbow-mode
        scratch scss-mode simple-mode-line skewer-mode slime
        starter-kit starter-kit-js starter-kit-ruby surround
        use-package writegood-mode yasnippet))
