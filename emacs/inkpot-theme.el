...
(custom-theme-set-faces
  'inkpot 
        ...
        '(linum ((t (:foreground "#333344"))))
        '(linum-relative-current-face ((t (:background nil :foreground "#555577"))))
        ...
        '(vertical-border ((t (:foreground "#1e1e27"))))
        ...
        ;; git-gutter
        '(git-gutter:modified ((t (:foreground "#333344" :weight bold))))
        '(git-gutter:added ((t (:foreground "#b5bd68" :weight bold))))
        '(git-gutter:deleted ((t (:foreground "#cc6666" :weight bold))))
        '(git-gutter:unchanged ((t (:background "#f0c674"))))
        '(git-gutter-fr:modified ((t (:foreground "#333344" :weight bold))))
        '(git-gutter-fr:added ((t (:foreground "#b5bd68" :weight bold))))
        '(git-gutter-fr:deleted ((t (:foreground "#cc6666" :weight bold))))
        '(git-gutter-fr:unchanged ((t (:background "#f0c674"))))
        ...
        ;; IDO
        '(ido-subdir ((t (:foreground "#b294bb"))))
        '(ido-first-match ((t (:foreground "#de935f"))))
        '(ido-only-match ((t (:foreground "#b5bd68"))))
        '(ido-indicator ((t (:foreground "#cc6666" :background "#1d1f21"))))
        '(ido-virtual ((t (:foreground "#969896"))))
